...
function setAddedTick(productId) {
...
let number = JSON.parse(localStorage.getItem('totalCartProducts'));
console.log(number)
...
export function sumOfTotalProducts() {
    ...
    let totalCartProducts = totalProducts;
    localStorage.setItem('totalCartProducts', JSON.stringify(totalCartProducts));
}
